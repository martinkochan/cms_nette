...
class Container_647b7f2932 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'wwwDir' => 'C:\xampp\htdocs\cms-nette\www',
			'debugMode' => TRUE,
	...
	{
		return new Container_647b7f2932_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_647b7f2932_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_647b7f2932 $container)
	{
